...
class agedPayableReportConfig(models.Model):
    _name = 'aged.payable.report.config'
    _description = 'aged payable Report Configuration'
    _rec_name = "name"
    ...
    _sql_constraints = [
        ('unique_company_config', 'unique(company_id)',
         'Only one aged payable Configuration is allowed per company.'),
    ]
